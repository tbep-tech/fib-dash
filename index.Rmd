...
entmatrix <- reactive({
  ...
  out <- try(tbeptools::show_fibmatrix(enterodata, stas = stas, yrrng = c(NA, maxyr), indic = 'entero', plotly = T))
...
enterotomap <- reactive({
  ...
  tomap <- tbeptools::anlz_enteromap(enterodata, yrsel1, mosel1, areasel1, wetdry = TRUE, precipdata = catchprecip, 
