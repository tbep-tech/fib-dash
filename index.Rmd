...
```{r}
fillCol(flex = c(NA, 1),
  shinyWidgets::materialSwitch('segsel1', 'By bay segment?', value = F),
...
### *ENTEROCOCCUS* MAP SUMMARY - BY YEAR

### *ENTEROCOCCUS* MAP SUMMARY - BY YEAR AND MONTH
...
fillCol(flex = c(NA, 1),
  column(12,
    ...
    column(4,
      selectInput('areasel1', 'Select area:', choices = areas1, selected = c('HB', 'OTB'), width = '200%', multiple = T)
    )
  ),
...
### *ENTEROCOCCUS* AND *E. COLI* MAP SUMMARY - BY YEAR

### *ENTEROCOCCUS* AND *E. COLI* MAP SUMMARY - BY YEAR AND MONTH
